...
const footerLinks = {
  ...
  'Programs': [
    ...
    { name: 'Fat Loss', path: '/programs' },
    { name: 'Muscle Building', path: '/programs' },
    { name: 'Functional Training', path: '/programs' },
    { name: 'HIIT', path: '/programs' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Transform your body, transform your life. IRONPEAK Fitness Studio is Guntur's premier fitness destination with state-of-the-art equipment and expert trainers.
            </p>
            
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                <MapPin size={16} className="text-red-500 flex-shrink-0" />
                <span>123 Fitness Lane, Guntur, Andhra Pradesh 522001</span>
              </div>
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                <Phone size={16} className="text-red-500 flex-shrink-0" />
                <a href="tel:+919100527275" className="hover:text-white transition-colors">+91 9100527275</a>
              </div>
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                <Mail size={16} className="text-red-500 flex-shrink-0" />
                <a href="mailto:info@ironpeakfitness.com" className="hover:text-white transition-colors">info@ironpeakfitness.com</a>
              </div>
              <div className="flex items-center gap-3 text-gray-400 text-sm">
                <Clock size={16} className="text-red-500 flex-shrink-0" />
                <span>Mon-Sat: 5AM-10PM | Sun: 6AM-8PM</span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © 2026 IRONPEAK Fitness Studio. All rights reserved. | Owner: Shaik Mohammad Hafizulla
            </p>
            <div className="flex items-center gap-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="YouTube">
                <svg viewBox="0 0 24 24" className="w-[18px] h-[18px] fill-current"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <button
                onClick={() => openWhatsApp('Hello! I would like to know more about IRONPEAK Fitness Studio.')}
